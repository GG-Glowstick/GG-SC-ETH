...
/**
 * @title Interface for GAMERSGOLD Protocol's Media
 */
interface IMedia {
...
contract WhiteRareMedia is IMedia, ERC721Burnable, ReentrancyGuard {
     ...
     */
    constructor(address WhiteRareMarketContractAddress) public ERC721("GAMERSGOLD", "GAMERSGOLD") {
